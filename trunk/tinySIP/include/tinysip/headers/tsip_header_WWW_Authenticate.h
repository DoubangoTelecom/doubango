...
* @sa TSIP_HEADER_WWW_AUTHENTICATE_SAFE_FREE.
*/
/**@def TSIP_HEADER_WWW_AUTHENTICATE_SAFE_FREE
* Safely free a sip 'WWW-AUTHENTICATE' header previously created using TSIP_HEADER_WWW_AUTHENTICATE_CREATE.
* @sa TSIP_HEADER_WWW_AUTHENTICATE_CREATE.
*/
#define TSIP_HEADER_WWW_AUTHENTICATE_CREATE()				tsk_object_new(tsip_header_WWW_Authenticate_def_t)
#define TSIP_HEADER_WWW_AUTHENTICATE_SAFE_FREE(self)		tsk_object_unref(self), self = 0
