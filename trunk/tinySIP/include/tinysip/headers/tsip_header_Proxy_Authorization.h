...
* Creates new sip 'PROXY-AUTHORIZATION' header.  You must call @ref TSIP_HEADER_PROXY_AUTHORIZATION_SAFE_FREE to free the header.
* @sa TSIP_HEADER_PROXY_AUTHORIZATION_SAFE_FREE.
*/
/**@def TSIP_HEADER_PROXY_AUTHORIZATION_SAFE_FREE
* Safely free a sip 'PROXY-AUTHORIZATION' header previously created using TSIP_HEADER_PROXY_AUTHORIZATION_CREATE.
* @sa TSIP_HEADER_PROXY_AUTHORIZATION_CREATE.
*/
#define TSIP_HEADER_PROXY_AUTHORIZATION_CREATE()			tsk_object_new(tsip_header_Proxy_Authorization_def_t)
#define TSIP_HEADER_PROXY_AUTHORIZATION_SAFE_FREE(self)		tsk_object_unref(self), self = 0
...
TINYSIP_API const void *tsip_header_Proxy_Authorization_def_t;
